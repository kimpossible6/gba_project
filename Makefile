...
SOURCES            = main.c myLib.c text.c font.c splash.c start.c instruction.c pause.c lose.c win.c level1.c spritesheet.c gamebg.c sky.c sea.c sound.c theme.c gameSong.c hitbird.c matchSound.c pauseSong.c
CCPATH             = /usr/bin
DKPATH             = /Users/ziwei/Desktop/Software/devkitARM/bin
VBASIM             = open /Users/ziwei/Desktop/Software/visualboyadvance-m.app
FIND               = find
COPY               = cp -r
